<template>
  <div class="app-container">
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="40%" >
      <el-form ref="dataForm" :model="sysMenu" :rules="validateRules" label-width="150px" size="small" style="padding-right: 40px;">
        ...
        <el-form-item :prop="sysMenu.type !== 2 ? 'path' : ''">
              <span slot="label">
        ...
        <el-form-item :prop="sysMenu.type !== 2 ? 'component' : ''" v-if="sysMenu.type !== 0">
              <span slot="label">
        ...
        <el-form-item prop="perms" v-if="sysMenu.type === 2">
  ...
  data() {
    return {
      ...
      validateRules: {
        ...
        icon: [{ required: true, trigger: 'blur', message: '必须选择' }],
        path: [{ required: true, trigger: 'blur', message: '必须输入' }],
        component: [{ required: true, trigger: 'blur', message: '必须输入' }],
        perms: [{ required: true, trigger: 'blur', message: '必须输入' }]
      },
