      ...
      <div class="personal-patient">
        ...
        <div>
          ...
          <div class="content-wrapper">
            <el-form>
              <el-form-item label="姓名：">
                <div class=""><span>{{ patient.contactsName }}</span></div>
              </el-form-item>
              <el-form-item label="证件类型：">
                <div class=""><span>{{ patient.param.contactsCertificatesTypeString }}</span></div>
              </el-form-item>
              <el-form-item label="证件号码：">
                <div class=""><span>{{ patient.contactsCertificatesNo }} </span></div>
              </el-form-item>
              <el-form-item label="手机号：">
                <div class=""><span>{{ patient.contactsPhone }} </span></div>
              </el-form-item>
              <el-form-item>
                <br>
