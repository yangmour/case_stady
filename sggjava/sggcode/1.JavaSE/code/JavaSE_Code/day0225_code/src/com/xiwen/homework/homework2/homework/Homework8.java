package com.xiwen.homework.homework2.homework;
...
public class Homework8 {
    public static void main(String[] args) {
        ...
        String[] province = str.replaceAll("'|\\[|\\]| ", "").split(";");

        HashMap<Integer, String> provinceStrMap = new HashMap<>();
        HashMap<Integer, ArrayList<String>> countyMap = new HashMap<>();

        for (int i = 0; i < province.length; i++) {
            String[] provinceAndCounty = province[i].split(":");
            //将省和直辖市放入map中格式如：1->北京
            provinceStrMap.put(i + 1, provinceAndCounty[0]);

            //存放市区
            ArrayList<String> list = new ArrayList<>();
            String[] county = provinceAndCounty[1].split(",");
            for (int j = 0; j < county.length; j++) {
                list.add(county[j]);
            }
            countyMap.put(i + 1, list);
        }

        Set<Map.Entry<Integer, String>> entries = provinceStrMap.entrySet();
        ...
        String s = provinceStrMap.get(i);
        ArrayList<String> strings = countyMap.get(i);
